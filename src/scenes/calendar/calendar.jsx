...
// Save events to local storage whenever they are updated
useEffect(() => {
  console.log("Saving events to localStorage:", currentEvents);
...
const handleDateClick = (selected) => {
  ...
  if (title) {
    const newEvent = {
      id: `event-${Date.now()}`, // Generate a unique ID for the event
      title,
...
// Rest of your component code...
  ...
  const handleEventClick = (selected) => {
    if (window.confirm(`Are you sure you want to delete the event '${selected.event.title}'`)) {
      // Remove the event from currentEvents based on its id
